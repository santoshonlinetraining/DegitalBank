...
//
	public static void main(String[] args) {
		...
		System.out.println(driver.findElement(By.id("newsletter")).isSelected()); // true
		
		//click on the check box 
		driver.findElement(By.id("newsletter")).click();
		
		//get the check box status
		System.out.println(driver.findElement(By.id("newsletter")).isSelected()); // false
		
		System.out.println("get day : " + driver.findElement(By.id("days")).getAttribute("value"));
		
		System.out.println(" get state : "+driver.findElement(By.xpath("//select[@id='id_state']")).getAttribute("value"));
